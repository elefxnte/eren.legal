...
export default async function RecentlyListenedSongs() {
  ...
  return (
    <div className="flex w-full flex-col gap-3 rounded-lg border bg-card px-5 py-5 drop-shadow-2xl xl:col-span-3">
      <div className="flex w-full flex-row items-center justify-between">
        <span className="flex flex-row items-center gap-2 text-muted">
          Recently Listened Songs
        </span>
      </div>
      <div className="grid grid-cols-1 gap-x-3 gap-y-2 lg:grid-cols-3">
